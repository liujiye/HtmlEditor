 ...
 * provided with HTML 4.01 are given, plus some that are IE-specific and
...
public class HTMLSchema extends Schema implements HTMLModels
{
	...
	public HTMLSchema()
	{
		...
		elementType("del", M_PCDATA | M_INLINE | M_BLOCK, M_INLINE | M_BLOCKINLINE | M_BLOCK,
				F_RESTART);
		...
		elementType("form", M_PCDATA | M_INLINE | M_NOLINK | M_BLOCK | M_TR | M_CELL, M_BLOCK
				| M_FORM, F_NOFORCE);
		...
		elementType("object", M_PCDATA | M_PARAM | M_INLINE | M_BLOCK,
				M_HEAD | M_INLINE | M_NOLINK, 0);
