...
public class XMLWriter extends XMLFilterImpl implements LexicalHandler
{
	...
	{
		if (!(htmlMode && (uri.equals("http://www.w3.org/1999/xhtml") || uri.equals("")) && (qName
				.equals("area")
				|| qName.equals("base")
				...
				|| qName.equals("img")
				|| qName.equals("input")
				|| qName.equals("isindex") || qName.equals("link") || qName.equals("meta") || qName
					.equals("param"))))
		{
			write("</");
			writeName(uri, localName, qName, true);
	...
	private String[] booleans = { "checked", "compact", "declare", "defer", "disabled", "ismap",
