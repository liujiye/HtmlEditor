package com.ljy.htmleditor.widget;
...
public class ColorPickerDialog extends Dialog
{
	...
	private static class ColorPickerView extends View
	{
		...
		ColorPickerView(Context c, OnColorChangedListener l, int color)
		{
			...
			mListener = l;
			// 渐变色数组
			mColors = new int[] { 0xFF000000, 0xFFFFFFFF, 0xFFFFFF00, 0xFFFF0000, 0xFF00FFFF,
					0xFF0000FF, 0xFF000000 };
			// mColors = new int[] {// 渐变色数组
			// 0xFFFFFFFF, 0xFFFF0000, 0xFFFF00FF, 0xFF0000FF, 0xFF00FFFF,
